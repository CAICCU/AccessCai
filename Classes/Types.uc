...
struct YASSettingsAdmin
{
	...
	StructDefaultProperties
	{
		...
		ApplyColorToFields = (Rank=True, Player=True, Level=False, Perk=False, Dosh=False, Kills=False, Assists=False, Health=False, Armor=False, DamageDealtOnTeam=False, Ping=False)
	}
};
...
struct YASStyle
{
	...
	var ColorRGBA DamageDealtOnTeamTextColorLow;
    var ColorRGBA DamageDealtOnTeamTextColorMid;
    var ColorRGBA DamageDealtOnTeamTextColorHigh;
	...
	var bool      DamageDealtOnTeamTextSmoothColorChange;
	...
	StructDefaultProperties
	{
		...
		// DamageDealtOnTeam text
		DamageDealtOnTeamTextColorLow   = (R=250, G=250, B=250, A=255)
		DamageDealtOnTeamTextColorMid   = (R=250, G=250, B=250, A=255)
		DamageDealtOnTeamTextColorHigh  = (R=250, G=250, B=250, A=255)
		...
		DoshTextSmoothColorChange       = false//false
		KillsTextSmoothColorChange      = false
		AssistsTextSmoothColorChange    = false
		DamageDealtOnTeamTextSmoothColorChange  = false
		PingTextSmoothColorChange       = false//false
	}
};
